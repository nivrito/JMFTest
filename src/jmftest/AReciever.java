 ...
 * @author Nivrito
 */
public class AReciever implements ControllerListener{
    ...
    AReciever() {
        ...
        rtpsocket = new javax.media.rtp.RTPSocket();
        ...
        System.out.println("RTCPSOURCE: "+rtcpsource);
        // connect the RTP socket data source before 
        // creating the player
        try {
            System.out.println("RTPSOCKET: "+rtpsocket);
            rtpsocket.connect();
            System.out.println("RTCP COnnected");
...
// INNER CLASS UDP Handler which will receive UDP RTP Packets and
    ...
    // underlying network.
     class UDPHandler extends Thread implements PushSourceStream, 
                                                      OutputDataStream
    {
